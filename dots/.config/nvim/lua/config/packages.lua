...
vim.pack.add({
  ...
  "https://github.com/Ronxvier/ymir.nvim",
  ...
  "https://github.com/builtbyleo/oc-2.nvim",
  ...
  -- upstream bavajitu/blacklust.nvim was deleted
  "https://github.com/fallwith/blacklust.nvim",
